...
const tools = [
{
  ...
  "required": [
    "body"
      ...
      handler: (args) => genericHandler({"path":"/union-any","method":"post","pathParams":[],"queryParams":[],"headerParams":[],"cookieParams":[],"security":[],"inputSchema":{"type":"object","properties":{"body":{"anyOf":[{"type":"object","properties":{"a":{"type":"string"}},"required":["a"]},{"type":"object","properties":{"b":{"type":"number"}},"required":["b"]}]}},"required":["body"]}}, args)
    },
{
      name: 'testUnionOne',
      description: 'oneOf body schema',
      inputSchema: {
  "type": "object",
  "properties": {
    "body": {
  ...
  "required": [
    "body"
      ...
      handler: (args) => genericHandler({"path":"/union-one","method":"post","pathParams":[],"queryParams":[],"headerParams":[],"cookieParams":[],"security":[],"inputSchema":{"type":"object","properties":{"body":{"oneOf":[{"type":"object","properties":{"x":{"type":"boolean"}},"required":["x"]},{"type":"object","properties":{"y":{"type":"integer"}},"required":["y"]}]}},"required":["body"]}}, args)
    },
{
      name: 'testUnionNested',
      description: 'nested anyOf/oneOf body schema',
      inputSchema: {
  "type": "object",
  "properties": {
    "body": {
  ...
  "required": [
    "body"
      ...
      handler: (args) => genericHandler({"path":"/union-nested","method":"post","pathParams":[],"queryParams":[],"headerParams":[],"cookieParams":[],"security":[],"inputSchema":{"type":"object","properties":{"body":{"anyOf":[{"type":"object","properties":{"inner":{"oneOf":[{"type":"string"},{"type":"number"}]}},"required":["inner"]},{"type":"object","properties":{"flag":{"type":"boolean"}},"required":["flag"]}]}},"required":["body"]}}, args)
    },
{
      name: 'testUnionArray',
  ...
  "required": [
    "body"
      ...
      handler: (args) => genericHandler({"path":"/union-array","method":"post","pathParams":[],"queryParams":[],"headerParams":[],"cookieParams":[],"security":[],"inputSchema":{"type":"object","properties":{"body":{"type":"array","items":{"oneOf":[{"type":"string"},{"type":"number"}]}}},"required":["body"]}}, args)
    }
];
